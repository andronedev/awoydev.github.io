...
fetch('https://api.github.com/users/awoydev/repos').then(function(response) {
    ...
    data.forEach(function(repo) {
        ...
        description.innerHTML = repo.description == null? "" : repo.description + ' (' + (repo.language == null? "" : repo.language + ', ')  + repo.stargazers_count + ' '+icon_star+')';
